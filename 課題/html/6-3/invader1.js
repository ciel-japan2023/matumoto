...
var invDispArea = 200;
// 1列に表示するインベーダーの数
var invRowQty = (invQty / invRow);
// インベーダー同士の間隔
var invDistance = invDispArea / invRowQty * 0.3;
// インベーダーの縦横幅
var invW = invDispArea / invRowQty - invDistance;
...
var invMoveYCnt = 20;
// インベーダーの横方向に進む距離
var invMoveX = (600 - invMaxX) / invMoveXCnt;
// インベーダーの縦方向に進む距離
var invMoveY = (invDispArea - invMaxY) / invMoveYCnt;
