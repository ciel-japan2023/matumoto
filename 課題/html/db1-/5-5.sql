select em_m_location.location_name,em_m_item.item_type,sum(em_t_stock_item.item_qty),em_m_code.code_name
...
group by em_m_item.item_type,em_m_location.location_name,em_m_code.code_name
having 30 <= sum(em_t_stock_item.item_qty)
ORDER BY em_m_item.item_type desc,SUM(item_qty);